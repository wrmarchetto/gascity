...
/**
 * Get v0 city by city name beads label policy
 */
export const getV0CityByCityNameBeadsLabelPolicy = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameBeadsLabelPolicyData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameBeadsLabelPolicyResponses, GetV0CityByCityNameBeadsLabelPolicyErrors, ThrowOnError>({ url: '/v0/city/{cityName}/beads/label-policy', ...options });
