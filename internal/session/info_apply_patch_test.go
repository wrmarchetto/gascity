...
var allProjectedMetadataKeys = []string{
	...
	aliasHistoryMetadataKey, "continuity_eligible", "last_woke_at", "awake_started_at", "usage_compute_emitted_at", "usage_model_swept_at", "state_reason",
	...
	MetadataLastNudgeDeliveredAt, MetadataLastPokeAt, MetadataLastPokePriorActivity,
	"provider_kind", "builtin_ancestor",
...
func oracleBaseBeads() []beads.Bead {
	...
	populated := map[string]string{
		...
		"usage_model_swept_at": "2026-01-02T00:30:00Z",
