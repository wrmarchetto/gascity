...
type DoctorConfig struct {
	...
	// unpushed commits) — never by role identity. Stashes are
	// deliberately not among them: refs/stash is repo-wide, and a
	// stash survives worktree removal (bead ci-auomj).
...
type DaemonConfig struct {
	...
	// tree and no commits that removal would orphan — commits reachable
	// from no branch, tag, or remote-tracking ref — are removed;
