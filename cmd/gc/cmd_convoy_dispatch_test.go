...
func TestWorkflowServeControlReadyQueryUsesControlTiers(t *testing.T) {
	...
	for _, want := range []string{
		`bd --readonly --sandbox ready --assignee="$cand" --exclude-type=epic --exclude-type=message --json --limit=20`,
...
func TestWorkflowServeControlReadyQueryBD105IncludesEphemeral(t *testing.T) {
	...
	for _, want := range []string{
		`bd --readonly --sandbox ready --include-ephemeral --assignee="$cand" --exclude-type=epic --exclude-type=message --json --limit=20`,
...
case "$*" in
  ...
  "--readonly --sandbox ready --assignee=gascity--control-dispatcher --json --limit=20")
    ...
    ;;
  "--readonly --sandbox ready --assignee=gascity--control-dispatcher --exclude-type=epic --exclude-type=message --json --limit=20")
    printf '[{"id":"ga-ready"}]'
    ;;
...
`), 0o755); err != nil {
	...
	if want := "--readonly --sandbox ready --assignee=gascity--control-dispatcher --exclude-type=epic --exclude-type=message --json --limit=20"; firstCall != want {
